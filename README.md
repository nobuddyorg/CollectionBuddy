...
![Squawk](https://img.shields.io/badge/migration%20safety-Squawk-6E56CF)
...
![Splinter](https://img.shields.io/badge/DB%20lint-Splinter-3ECF8E?logo=supabase&logoColor=white)
...
[![Load test (k6)](https://github.com/nobuddyorg/CollectionBuddy/actions/workflows/k6-load-test.yml/badge.svg)](https://github.com/nobuddyorg/CollectionBuddy/actions/workflows/k6-load-test.yml)
[![codecov](https://img.shields.io/codecov/c/github/nobuddyorg/CollectionBuddy?logo=codecov&logoColor=white)](https://codecov.io/gh/nobuddyorg/CollectionBuddy)
