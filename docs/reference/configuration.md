...
| `zap_baseline` | Passive DAST findings, PASS/WARN/IGNORE/FAIL per rule | `report_md.md`, written by `zaproxy/action-baseline` itself into the workspace, cat'd straight in — no summary script needed on our side this time |
