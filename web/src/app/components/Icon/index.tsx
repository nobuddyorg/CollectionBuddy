...
const Icon: React.FC<IconProps> = ({ icon, rimId, children, ...props }) => {
  switch (icon) {
    ...
    case IconType.Frame:
      return (
        ...
        >
          ...
          {/* Points inward (+x): a negative run here draws off-canvas and the leg goes missing. */}
    ...
    default: {
      // Compile error on an unhandled member; a numeric enum would otherwise fall through silently.
